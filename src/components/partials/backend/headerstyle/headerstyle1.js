							...
							<Col sm="12">
								<Navbar expand="lg" className="p-0">
									...
									<Navbar.Brand className="navbar-brand" href="/">
										<img
											className="img-fluid logo logo-dark"
									...
									<Navbar.Collapse className="">
										<div className="menu-main-menu-container">
											<Nav as="ul" id="top-menu" className="ml-auto">
												...
												<li className="menu-item">
													<Link to="/movie-category">Latest News</Link>
												</li>

												<li className="menu-item">
													<Link to="#">News Catagories</Link>
												...
												<li className="menu-item">
													<Link to="/show-category">News Archive</Link>
												</li>
												<li className="menu-item">
													<Link to="/pricing-plan-1">PRICING PLANS</Link>
												</li>
												<li className="menu-item">
													<Link to="#">About</Link>
													<ul className="sub-menu">
														...
														<li className="menu-item">
															...
															<ul className="sub-menu">
																<li className="menu-item">
																	<Link to="/pricing-plan-1">Pricing Plan 1</Link>
																</li>
																<li className="menu-item">
																	<Link to="/pricing-plan-2">Pricing Plan 2</Link>
																</li>
															</ul>
														</li>
													</ul>
