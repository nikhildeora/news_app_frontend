							...
							<Col lg="7">
								...
								<div className="widget text-left">
									<div className="textwidget">
										<p>
											<small>
												© 2023 RightNewsOnline. All Rights Reserved. All videos and shows on
												this platform are trademarks of, and all related images and content are
												the property of, RightNewsOnline PVT LTD. Duplication and copy of this
								...
								<div className="widget text-left">
									<div className="textwidget">
										...
										<div className="d-flex align-items-center">
											...
											<br />
											<Link className="ml-3 app-image" to="#">
